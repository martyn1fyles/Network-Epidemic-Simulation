...
def test_initialise_data_structure():
    ...
    my_data = epidemic_data(G_test, initial_infected = [0], debug=True)
...
def test_update_infection_stage():
    ...
    """
    G_test = nx.complete_graph(10)
    my_data = epidemic_data(G_test, initial_infected = [1], debug=True)
...
def test_initialise_data_structure_tuple_nodes():
    ...
    my_data = epidemic_data(G_test, initial_infected = [(0,0)], debug=True)
...
def test_update_infection_stage_tuple_nodes():
    ...
    """
    G_test = nx.grid_2d_graph(2,2)
    my_data = epidemic_data(G_test, initial_infected = [(1,1)], debug=True)
...
def test_initialise_data_structure_infected_as_int():
    ...
    """
    G_test = nx.grid_2d_graph(2,2)
    my_data = epidemic_data(G_test, initial_infected = 4, debug=True)
...
def test_resistances_not_same_element():
    ...
    """
    G_test = nx.grid_2d_graph(2,2)
    my_data = epidemic_data(G_test, initial_infected = 1)
